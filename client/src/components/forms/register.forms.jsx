        ...
        <div className='mt-10'>
                <form className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-1'>
                        {/* label */}
                        <label className='text-[10px] font-semibold'htmlFor='first_name'>First Name: </label>
                        {/* input */}
                        <input className='border border-gray-400 px-2 py-2.5 rounded-md focus:outline-blue-400' id='first_name' type='text' placeholder='First Name' required/>
                    </div>
                    {/* last name */}
                    <div className='flex flex-col gap-1'>
                        {/* label */}
                        <label className='text-[10px] font-semibold' htmlFor="last_name">Last Name: </label>
                        {/* input */}
                        <input className='border border-gray-400 px-2 py-2.5 rounded-md focus:outline-blue-400' id="last_name" type='text' placeholder='Last Name' required />
                    </div>
                    <div className='flex flex-col gap-1'>
                        {/* label */}
                        <label className='text-[10px] font-semibold' htmlFor="email">Email: </label>
                        {/* input */}
                        <input className='border border-gray-400 px-2 py-2.5 rounded-md focus:outline-blue-400' id="email" type='email' placeholder='Email' required />
                    </div>
                    <div className='flex flex-col gap-1'>
                        {/* label */}
